...
namespace SchoolManagementSystem
{
    public partial class teacher : Form
    {
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            try
            {
                SqlConnection con = new SqlConnection(@"Data Source=.\SQLEXPRESS;AttachDbFilename=F:\Sem.4\C# Projects\College management system\CollegeManagementSystem\SchoolManagementSystem\clz.mdf;Integrated Security=True;User Instance=True");
                con.Open();
