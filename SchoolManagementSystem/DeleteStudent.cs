...
namespace SchoolManagementSystem
{
    public partial class DeleteStudent : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                using (SqlConnection con = new SqlConnection(@"Data Source=.\SQLEXPRESS;AttachDbFilename=F:\Sem.4\C# Projects\College management system\CollegeManagementSystem\SchoolManagementSystem\school.mdf;Integrated Security=True;User Instance=True"))
                {
